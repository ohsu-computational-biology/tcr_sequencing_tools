...
clone.dir <- arguments[1];    # Since this doesn't use the mutliplex, just use export_clones instead of normalized
out.dir <- arguments[2];
...
print(i)
    ...
    true[i] <- diversity(.data = clone.curr.record[[column_v]], .do.norm = F, .q = 1)

...
OUT=$data/QC/
MYBIN=$tool/analysis/freqGroupDiversityAnalysis.R          # Path to shell script or command-line executable that will be used
...
cmd="/usr/bin/Rscript $MYBIN $IN $OUT FALSE $FREQGRP" 

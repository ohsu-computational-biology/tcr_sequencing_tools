...
OUT=$data/QC/decontam_id/           # Directory where output files should be written
MYBIN=$tool/misc/save_decontam_read_ids.R          # Path to shell script or command-line executable that will be used

...
IN=$data/mixcr/extended              # Directory containing all input files. Should be one job per file
...
BASE="${CURRFILE%%S[0-9]*}"
SNUM="${CURRFILE%%_extended.vdjca}"; SNUM="${SNUM##*S}"
...
ASSEMBLY=$OUT/$BASE\S$SNUM\_clones.clns
